...
if ($_SESSION['Admin'] || $_SESSION['Lurah']) {     
?> 
...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="assets/images/<?= $meta['logo'] ?>">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidenav-menu">
            ...
            <a href="index.php" class="logo">
                <span class="logo-light">
                    <span class="logo-lg" style="text-transform: uppercase; color: white;"><img src="assets/images/<?= $meta['logo'] ?>" alt="logo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?= $meta['singkat'] ?></span>
                    <span class="logo-sm"><img src="assets/images/<?= $meta['logo'] ?>" alt="small logo"></span>
                </span>
            ...
            <div data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a data-bs-toggle="collapse" href="#DTmaster" aria-expanded="false" aria-controls="DTmaster" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-database"></i></span>
                            <span class="menu-text"> Data Master</span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="DTmaster">
                            <ul class="sub-menu">
                                <li class="side-nav-item"><a href="?page=admin" class="side-nav-link"><span class="menu-text">Admin</span></a></li>
                                <li class="side-nav-item"><a href="?page=pengaturan&id_meta=<?php echo $meta['id_meta'] ?>" class="side-nav-link"><span class="menu-text">Pengaturan</span></a></li> 
                                <li class="side-nav-item"><a href="?page=jabatan" class="side-nav-link"><span class="menu-text">Jabatan</span></a></li>
                                <li class="side-nav-item"><a href="?page=agama" class="side-nav-link"><span class="menu-text">Agama</span></a></li>
                                <li class="side-nav-item"><a href="?page=darah" class="side-nav-link"><span class="menu-text">Golongan Darah</span></a></li>
                                <li class="side-nav-item"><a href="?page=pekerjaan" class="side-nav-link"><span class="menu-text">Pekerjaan</span></a></li>
                                <li class="side-nav-item"><a href="?page=pendidikan" class="side-nav-link"><span class="menu-text">Pendidikan</span></a></li> 
                                <li class="side-nav-item"><a href="?page=jenis_surat" class="side-nav-link"><span class="menu-text">Jenis Surat</span></a></li> 
                            </ul>
                        </div>
                    </li> 

                    <li class="side-nav-item">
                        <a href="?page=pegawai" class="side-nav-link">
                    ...
                    <li class="side-nav-item">
                        <a href="?page=warga" class="side-nav-link">
                            <span class="menu-icon"><i class="ti ti-users"></i></span>
                    ...
                    <?php if ($_SESSION['Admin'] || $_SESSION['Lurah']) { ?>
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarMultiLevel">
                            <ul class="sub-menu">
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel1" aria-expanded="false" aria-controls="sidebarSecondLevel1" class="side-nav-link">
                                        <span class="menu-text"> Pegawai </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel1">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/pegawai_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#pegawai_jabatan" class="side-nav-link">
                                                    <span class="menu-text">Per Jabatan</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel2" aria-expanded="false" aria-controls="sidebarSecondLevel2" class="side-nav-link">
                                        <span class="menu-text"> Warga </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel2">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/warga_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#warga_jk" class="side-nav-link">
                                                    <span class="menu-text">Per Jenis Kelamin</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel3" aria-expanded="false" aria-controls="sidebarSecondLevel3" class="side-nav-link">
                                        <span class="menu-text"> SK Domisili </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel3">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/domisili_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#domisili_periode" class="side-nav-link">
                                                    <span class="menu-text">Per Periode</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel4" aria-expanded="false" aria-controls="sidebarSecondLevel4" class="side-nav-link">
                                        <span class="menu-text"> SK Usaha </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel4">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/usaha_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#usaha_periode" class="side-nav-link">
                                                    <span class="menu-text">Per Periode</span>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel5" aria-expanded="false" aria-controls="sidebarSecondLevel5" class="side-nav-link">
                                        <span class="menu-text"> SK Tidak Mampu </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel5">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/sktm_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#sktm_periode" class="side-nav-link">
                                                    <span class="menu-text">Per Periode</span>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel6" aria-expanded="false" aria-controls="sidebarSecondLevel6" class="side-nav-link">
                                        <span class="menu-text"> SK Belum Pernah Menikah </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel6">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/bp_menikah_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#bp_menikah_periode" class="side-nav-link">
                                                    <span class="menu-text">Per Periode</span>
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <li class="side-nav-item">
                                    <a data-bs-toggle="collapse" href="#sidebarSecondLevel7" aria-expanded="false" aria-controls="sidebarSecondLevel7" class="side-nav-link">
                                        <span class="menu-text"> S Pengantar SKCK </span>
                                        <span class="menu-arrow"></span>
                                    </a>
                                    <div class="collapse" id="sidebarSecondLevel7">
                                        <ul class="sub-menu">
                                            <li class="side-nav-item">
                                                <a href="page/laporan/skck_rekap.php" target="_blank" class="side-nav-link">
                                                    <span class="menu-text">Rekap Data</span>
                                                </a>
                                            </li>
                                            <li class="side-nav-item">
                                                <a href="javascript: void(0);" data-bs-toggle="modal" data-bs-target="#skck_periode" class="side-nav-link">
                                                    <span class="menu-text">Per Periode</span>
                                                </a>
                                            </li>
                                        </ul>
        ...
        <header class="app-topbar">
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="index.php" class="logo">
                        <span class="logo-light">
                            <span class="logo-lg"><img src="assets/images/<?= $meta['logo'] ?>" alt="logo"></span>
                            <span class="logo-sm"><img src="assets/images/<?= $meta['logo'] ?>" alt="small logo"></span>
                        </span>

                        <span class="logo-dark">
                            <span class="logo-lg"><img src="assets/images/<?= $meta['logo'] ?>" alt="dark logo"></span>
                            <span class="logo-sm"><img src="assets/images/<?= $meta['logo'] ?>" alt="small logo"></span>
                        </span>
                    </a>
                    ...
                    <div class="topbar-item nav-user">
                        <div class="dropdown">
                            <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown" data-bs-offset="0,19" type="button" aria-haspopup="false" aria-expanded="false">
                                <img src="assets/images/admin/<?= $admin['foto'] ?>" width="32" class="rounded-circle me-lg-2 d-flex" alt="user-image">
        ...
        <div class="page-content">
            <div class="page-container">
                ...
                if ($page == "warga") 
                {
                    if ($aksi == "") { include "page/warga/warga.php"; }
                    if ($aksi == "tambah") { include "page/warga/tambah.php"; }  
                    if ($aksi == "ubah") { include "page/warga/ubah.php"; }   
                    if ($aksi == "lihat") { include "page/warga/lihat.php"; }   
                    if ($aksi == "hapus") { include "page/warga/hapus.php"; } 
                }     

                if ($page == "jenis_surat") 
                {
                    if ($aksi == "") { include "page/jenis_surat/jenis_surat.php"; }
                    if ($aksi == "tambah") { include "page/jenis_surat/tambah.php"; }  
                    if ($aksi == "ubah") { include "page/jenis_surat/ubah.php"; }   
                    if ($aksi == "hapus") { include "page/jenis_surat/hapus.php"; }  
                }         
    ...
    <script>
        $(document).ready(function () {
            $.get('grafik_warga.php', function (data) {
                Highcharts.chart('grafik_umur', {
                    ...
                    subtitle: {
                        text: 'Sumber: Data Warga'
                    },
                    xAxis: {
                        categories: ['Anak-Anak (0-5 Tahun)', 'Remaja (5-13 Tahun)', 'Dewasa (14-40 Tahun)', 'Lansia (>40 Tahun)'],
                        title: {
                            text: null
                        },
                        gridLineWidth: 1,
                    ...
                    series: [{
                        name: 'Jumlah Warga',
                        data: data.umur.map(function(item) { return item.y; }),
                colorByPoint: true,
                colors: [
                    '#FF5733', // Anak-Anak (0-5 Tahun) - Warna Merah
                    '#33FF57', // Remaja (5-13 Tahun) - Warna Hijau
                    '#3357FF', // Dewasa (14-40 Tahun) - Warna Biru
                    '#FF33A1'  // Lansia (>40 Tahun) - Warna Pink
                ]
                    }]
                });
            });
