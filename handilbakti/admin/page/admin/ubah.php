        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Ubah Data Admin</h4> 
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select name="level" class="form-control">
                                ...
                                <option value="Lurah" <?= ($row['level'] == 'Lurah') ? 'selected' : ''; ?>>Lurah</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <img src="assets/images/admin/<?= $row['foto']; ?>" width="100"> <br>
                ...
                <?php 
                    ...
                    if ($foto != '') { 
                        ...
                        if ($data['foto'] != '') {
                            unlink("assets/images/admin/" . $data['foto']);
                        }
