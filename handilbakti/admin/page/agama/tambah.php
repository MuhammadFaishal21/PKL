        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Data Agama</h4> 
                </div>
            </div><!-- end card header -->
                ...
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            ...
                            <a href="?page=agama" class="btn btn-danger btn-sm">Kembali</a> 
                        </div>
                    </div> 
                </form>
                <?php                           
                    if (isset($_POST['tambah'])) {
                        ...
                        $cek_query = "SELECT COUNT(*) AS jumlah FROM agama WHERE agama = '$agama'";
                            ...
                            echo "<script>
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            window.location.href = '?page=agama';
                                        }
                                    });
                                  </script>";
                        } else {
