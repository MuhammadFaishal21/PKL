                    ...
                    <table id="dtTables" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php while ($pecah = $ambil->fetch_assoc()) { 
                                ...
                                $pengantar_rt = "assets/berkas/bp_menikah/" . $pecah['pengantar_rt'];
                                $fc_ktp = "assets/berkas/bp_menikah/" . $pecah['fc_ktp'];
                                $fc_kk = "assets/berkas/bp_menikah/" . $pecah['fc_kk'];
                                $pernyataan = "assets/berkas/bp_menikah/" . $pecah['pernyataan'];
                            ?>
                            <tr>      
