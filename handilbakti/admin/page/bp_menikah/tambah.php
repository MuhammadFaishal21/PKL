                ...
                <?php
                    if (isset($_POST['tambah'])) { 
                        ...
                        $query = "INSERT INTO bp_menikah 
                                  ...
                                  VALUES 
                                  ('$id_jenis_surat', '$no_bp_menikah', '$id_warga', '$tgl_pengajuan', '$keperluan', '{$fileFields['pengantar_rt']}', '{$fileFields['fc_ktp']}', '{$fileFields['fc_kk']}', '{$fileFields['pernyataan']}', '$status_bp_menikah')";
