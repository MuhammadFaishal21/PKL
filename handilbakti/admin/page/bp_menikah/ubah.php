            ...
            <div class="card-body">
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select name="status_bp_menikah" class="form-control">
                                <option value="Pending" <?= $data['status_bp_menikah'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                <option value="Acc" <?= $data['status_bp_menikah'] == 'Acc' ? 'selected' : '' ?>>Acc</option> 
                                <option value="Upload Ulang Berkas" <?= $data['status_bp_menikah'] == 'Upload Ulang Berkas' ? 'selected' : '' ?>>Upload Ulang Berkas</option>
                                <option value="Ditolak" <?= $data['status_bp_menikah'] == 'Ditolak' ? 'selected' : '' ?>>Ditolak</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-2">
                ...
                <?php
                    if (isset($_POST['ubah'])) {
                        ...
                        $status_bp_menikah = $_POST['status_bp_menikah'];

                        $uploadDir = "assets/berkas/bp_menikah/";
                        $updateFields = "";
                        ...
                        $query = "UPDATE bp_menikah SET keperluan = '$keperluan', status_bp_menikah = '$status_bp_menikah' $updateFields WHERE id_bp_menikah = $id_bp_menikah";
