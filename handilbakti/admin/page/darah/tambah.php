        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Data Golongan Darah</h4> 
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <?php                           
                    if (isset($_POST['tambah'])) {
                        ...
                        $cek_query = "SELECT COUNT(*) AS jumlah FROM darah WHERE darah = '$darah'";
                        ...
                        $query = "INSERT INTO darah (darah) VALUES ('$darah')";
