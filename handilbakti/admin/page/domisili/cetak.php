...
$ambil  = $con->query("SELECT * FROM domisili NATURAL JOIN warga WHERE id_domisili ='$_GET[id_domisili]'");
        ...
        <div class="page">
            <div class="subpage">
                ...
                <table align="center">
                    ...
                    <tr>
                        <th style="font-size: 15px; text-align: center;">SURAT KETERANGAN DOMISILI<div class="horizontal_center_tipis"></div> </th>
                    </tr>
                    <tr>
                        <th style="font-size: 13px; text-align: center;">NOMOR : <?php echo $pecah['no_domisili'] ?></th>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                            Dengan ini menerangkan bahwa yang bersangkutan adalah penduduk / warga Kelurahan Handil Bakti Kecamatan Alalak Kabupaten Barito Kuala. Demikian Surat Ketetangan Domisili ini telah dibuat dengan benar dan diberikan kepada yang bersangkutan untuk dipergunakan dengan keperluan <?php echo $pecah['keperluan'] ?>.
