            ...
            <div class="card-body">
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select name="status_domisili" class="form-control">
                                <option value="Pending" <?= $data['status_domisili'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                <option value="Acc" <?= $data['status_domisili'] == 'Acc' ? 'selected' : '' ?>>Acc</option> 
                                <option value="Upload Ulang Berkas" <?= $data['status_domisili'] == 'Upload Ulang Berkas' ? 'selected' : '' ?>>Upload Ulang Berkas</option>
                                <option value="Ditolak" <?= $data['status_domisili'] == 'Ditolak' ? 'selected' : '' ?>>Ditolak</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-2">
                ...
                <?php
                    if (isset($_POST['ubah'])) {
                        ...
                        $uploadDir = "assets/berkas/domisili/";
                        $updateFields = "";
                        ...
                        $query = "UPDATE domisili SET keperluan = '$keperluan', status_domisili = '$status_domisili' $updateFields WHERE id_domisili = $id_domisili";
