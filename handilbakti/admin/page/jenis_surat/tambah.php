        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Data Jenis Surat</h4> 
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" action="">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kode_surat" required>
                        </div>
                    </div> 
                    <div class="row mb-2">
                ...
                <?php                           
                    if (isset($_POST['tambah'])) {
                        ...
                        $cek_query = "SELECT COUNT(*) AS jumlah FROM jenis_surat WHERE kode_surat = '$kode_surat'";
                        ...
                        $query = "INSERT INTO jenis_surat (kode_surat,nama_surat) VALUES ('$kode_surat','$nama_surat')";
