<?php
$nama_dokumen = 'Laporan Rekap SK Belum Pernah Menikah';
...
<body>
    ...
    <p align="center"><b>Laporan Rekap SK Belum Pernah Menikah</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM bp_menikah NATURAL JOIN warga ORDER BY id_bp_menikah ASC"); ?>
