<?php
$nama_dokumen = 'Laporan SK Domisili';
...
<body>
    ...
    <p align="center"><b>Laporan SK Domisili <br> <small>Berdasarkan Periode <?php echo $tgl1 ?> s/d <?php echo $tgl2 ?></small></b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM domisili NATURAL JOIN warga WHERE tgl_pengajuan BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id_domisili ASC"); ?>
        ...
        <tr>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['no_domisili']; ?></td>     
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;" align="center"><?php echo $pecah['status_domisili']; ?></td>   
        </tr> 
        <?php $nomor++; ?>
        <?php } ?> 
    </table> 
