<?php
$nama_dokumen = 'Laporan Rekap Pegawai';
...
<body>
    ...
    <p align="center"><b>Laporan Rekap Pegawai</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php 
            $nomor = 1; 
            $ambil = $con->query("SELECT * FROM pegawai NATURAL JOIN jabatan ORDER BY id_pegawai ASC"); 
