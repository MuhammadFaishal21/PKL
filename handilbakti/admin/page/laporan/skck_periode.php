<?php
$nama_dokumen = 'Laporan Surat Pengantar SKCK';
...
<body>
    ...
    <p align="center"><b>Laporan Surat Pengantar SKCK <br> <small>Berdasarkan Periode <?php echo $tgl1 ?> s/d <?php echo $tgl2 ?></small></b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM skck NATURAL JOIN warga WHERE tgl_pengajuan BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id_skck ASC"); ?>
