...
<body>
    ...
    <p align="center"><b>Laporan SK Usaha <br> <small>Berdasarkan Periode <?php echo $tgl1 ?> s/d <?php echo $tgl2 ?></small></b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        <tr>
            ...
            <td colspan="5"  style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; text-align: center;">Pemohon / Warga</td> 
        ...
        <tr>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; text-align: center;">Jenis Usaha</td>
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; text-align: center;">Nama Usaha</td>
        </tr> 
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM usaha NATURAL JOIN warga WHERE tgl_pengajuan BETWEEN '$tgl_awal' AND '$tgl_akhir' ORDER BY id_usaha ASC"); ?>
        ...
        <tr>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?php echo $pecah['no_usaha']; ?></td>     
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;" align="center"><?php echo $pecah['jenis_usaha']; ?></td>     
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;" align="center"><?php echo $pecah['nama_usaha']; ?></td>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;" align="center"><?php echo $pecah['status_usaha']; ?></td>   
        </tr> 
        <?php $nomor++; ?>
        <?php } ?> 
    </table> 
