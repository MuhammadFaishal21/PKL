<?php
$nama_dokumen = 'Laporan Rekap SK Usaha';
...
<body>
    ...
    <p align="center"><b>Laporan Rekap SK Usaha</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM usaha NATURAL JOIN warga ORDER BY id_usaha ASC"); ?>
