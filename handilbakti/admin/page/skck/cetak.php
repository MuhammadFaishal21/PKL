...
$ambil  = $con->query("SELECT * FROM skck NATURAL JOIN warga WHERE id_skck ='$_GET[id_skck]'");
        ...
        <div class="page">
            <div class="subpage">
                ...
                <table align="center">
                    ...
                    <tr>
                        <th style="font-size: 15px; text-align: center;">SURAT KETERANGAN KELAKUAN BAIK<div class="horizontal_center_tipis"></div> </th>
                    </tr>
                    <tr>
                        <th style="font-size: 13px; text-align: center;">NOMOR : <?php echo $pecah['no_skck'] ?></th>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                           Benar nama tersebut di atas adalah penduduk Kelurahan Handil Bakti, Kecamatan Alalak, Kabupaten Barito Kuala, berdasarkan data serta pengetahuan kami bahwa nama tersebut :
                        </td>
                    </tr> 
                </table>
                ...
                <table>  
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td style="font-size: 12px; text-align: justify;"><?php echo nl2br(htmlspecialchars($pecah['keterangan'])); ?></td>
                    </tr> 
                </table> 
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                            Surat keterangan ini dibuat dan diberikan untuk mendapatkan rekomendasi dari Kapolsek Kecamatan Alalak. Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.
                        </td>
                    </tr> 
                </table> 
