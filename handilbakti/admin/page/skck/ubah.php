            ...
            <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select name="status_skck" class="form-control">
                                <option value="Pending" <?= $data['status_skck'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                                <option value="Acc" <?= $data['status_skck'] == 'Acc' ? 'selected' : '' ?>>Acc</option> 
                                <option value="Upload Ulang Berkas" <?= $data['status_skck'] == 'Upload Ulang Berkas' ? 'selected' : '' ?>>Upload Ulang Berkas</option>
                                <option value="Ditolak" <?= $data['status_skck'] == 'Ditolak' ? 'selected' : '' ?>>Ditolak</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-2">
                ...
                <?php
                    if (isset($_POST['ubah'])) {
                        ...
                        $query = "UPDATE skck SET keterangan = '$keterangan', status_skck = '$status_skck' $updateFields WHERE id_skck = $id_skck";
