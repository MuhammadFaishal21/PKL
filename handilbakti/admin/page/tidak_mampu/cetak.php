...
$ambil  = $con->query("SELECT * FROM tidak_mampu NATURAL JOIN warga WHERE id_tidak_mampu ='$_GET[id_tidak_mampu]'");
        ...
        <div class="page">
            <div class="subpage">
                ...
                <table align="center">
                    ...
                    <tr>
                        <th style="font-size: 15px; text-align: center;">SURAT KETERANGAN TIDAK MAMPU<div class="horizontal_center_tipis"></div> </th>
                    </tr>
                    <tr>
                        <th style="font-size: 13px; text-align: center;">NOMOR : <?php echo $pecah['no_tidak_mampu'] ?></th>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                           Benar nama tersebut adalah penduduk Handil Bakti, Kecamatan Alalak, Kabupaten Barito Kuala, berdasarkan data serta pengetahuan kami bahwa nama tersebut di atas benar keluarga kurang mampu <b>(KELUARGA BERPENGHASILAN RENDAH)</b>. Dan Surat Keterangan ini diberikan untuk keperluan <?php echo $pecah['keperluan'] ?>.
                        </td>
                    </tr>
                </table> 
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                            Surat keterangan ini dibuat dan diberikan untuk mendapatkan rekomendasi dari Kapolsek Kecamatan Alalak dan untuk keperluan <?php echo $pecah['keperluan'] ?>. Demikian surat keterangan ini kami buat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.
                        </td>
                    </tr>
                </table> 
