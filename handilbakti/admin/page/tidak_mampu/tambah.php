                ...
                <?php
                    if (isset($_POST['tambah'])) { 
                        ...
                        if (move_uploaded_file($pengantarRtTmp, $pengantarRtPath) &&
                            ...
                            $query = "INSERT INTO tidak_mampu (id_jenis_surat, no_tidak_mampu, id_warga, tgl_pengajuan, keperluan, pengantar_rt, fc_ktp, fc_kk, status_tidak_mampu) VALUES ('$id_jenis_surat', '$no_tidak_mampu', '$id_warga', '$tgl_pengajuan', '$keperluan', '$pengantarRt', '$fcKtp', '$fcKk', '$status_tidak_mampu')";
