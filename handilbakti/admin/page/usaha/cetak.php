...
$ambil  = $con->query("SELECT * FROM usaha NATURAL JOIN warga WHERE id_usaha ='$_GET[id_usaha]'");
...
<head>
    ...
    <link rel="shortcut icon" href="../../assets/images/<?php echo $meta['logo'] ?>">
</head>
<style type="text/css">
        ...
        <div class="page">
            <div class="subpage">
                <table width="100%">  
                    <tr>
                        <td style="vertical-align: middle; text-align: center;">
                            <a href="#">
                                <img src="../../assets/images/<?php echo $meta['logo'] ?>" height="90px">
                            </a>
                        </td>
                ...
                <table align="center">
                    ...
                    <tr>
                        <th style="font-size: 15px; text-align: center;">SURAT KETERANGAN USAHA<div class="horizontal_center_tipis"></div> </th>
                    </tr>
                    <tr>
                        <th style="font-size: 13px; text-align: center;">NOMOR : <?php echo $pecah['no_usaha'] ?></th>
                    </tr>
                </table>
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                            Benar nama tersebut di atas adalah penduduk Handil Bakti, Kecamatan Alalak, Kabupaten Barito Kuala, dan menurut sepengetahuan kami yang bersangkutan memiliki Usaha :
                        </td>
                    </tr> 
                </table>
                ...
                <table>  
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jenis Usaha</td>
                        <td style="font-size: 12px; text-align: justify;">:</td>
                        <td style="font-size: 12px; text-align: justify;"><?php echo $pecah['jenis_usaha'] ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama Usaha</td>
                        <td style="font-size: 12px; text-align: justify;">:</td>
                        <td style="font-size: 12px; text-align: justify;"><?php echo $pecah['nama_usaha'] ?></td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Alamat Usaha</td>
                        <td style="font-size: 12px; text-align: justify;">:</td>
                        <td style="font-size: 12px; text-align: justify;"><?php echo $pecah['alamat_usaha'] ?></td>
                    </tr> 
                </table> 
                ...
                <table>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                            Demikian Surat Keterangan Usaha ini dibuat untuk keperluan <?php echo $pecah['keperluan'] ?>.
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 12px; text-align: justify;">
                ...
                <table align="right">
                    ...
                    <tr>
                        <td align="center">
                            <img src="../../assets/images/QRCode.png" width="85" height="85" alt="">
                        </td>
                    </tr>   
                    <tr>
