                    ...
                    <table id="dtTables" class="table table-striped table-bordered display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php while ($pecah = $ambil->fetch_assoc()) { 
                                ...
                                $pengantar_rt = "assets/berkas/usaha/" . $pecah['pengantar_rt'];
                                $fc_ktp = "assets/berkas/usaha/" . $pecah['fc_ktp'];
                                $fc_kk = "assets/berkas/usaha/" . $pecah['fc_kk'];
                                $fc_pbb = "assets/berkas/usaha/" . $pecah['fc_pbb'];
                                $foto_usaha = "assets/berkas/usaha/" . $pecah['foto_usaha'];
                            ?>
                            <tr>      
