                    ...
                    <table id="dtTables" class="table table-striped table-bordered display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php while ($pecah = $ambil->fetch_assoc()) { 
                                ...
                                $pengantar_rt = "../admin/assets/berkas/skck/" . $pecah['pengantar_rt'];
                                $fc_ktp = "../admin/assets/berkas/skck/" . $pecah['fc_ktp'];
                                $fc_kk = "../admin/assets/berkas/skck/" . $pecah['fc_kk'];
                                $fc_akta = "../admin/assets/berkas/skck/" . $pecah['fc_akta'];
                                $pas_foto = "../admin/assets/berkas/skck/" . $pecah['pas_foto'];
                            ?>
