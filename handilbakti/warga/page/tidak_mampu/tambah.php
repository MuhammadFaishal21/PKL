...
$sql = "SELECT MAX(CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(no_tidak_mampu, '/', 2), '/', -1) AS UNSIGNED)) AS last_number 
        FROM tidak_mampu 
        WHERE no_tidak_mampu LIKE '$kodeSurat / % / KESRA-HB / $tahun'";
        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Data Surat Keterangan Tidak Mampu</h4> 
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no_tidak_mampu" value="<?= $noSurat ?>" readonly required>
                        </div>
                    </div>  
                    <div class="row mb-2">
                ...
                <?php
                    if (isset($_POST['tambah'])) { 
                        ...
                        $uploadDir = "../admin/assets/berkas/tidak_mampu/";
                        ...
                        if (move_uploaded_file($pengantarRtTmp, $pengantarRtPath) &&
                            ...
                            $query = "INSERT INTO tidak_mampu (id_jenis_surat, no_tidak_mampu, id_warga, tgl_pengajuan, keperluan, pengantar_rt, fc_ktp, fc_kk, status_tidak_mampu) VALUES ('$id_jenis_surat', '$no_tidak_mampu', '$id_warga', '$tgl_pengajuan', '$keperluan', '$pengantarRt', '$fcKtp', '$fcKk', 'Pending')";
