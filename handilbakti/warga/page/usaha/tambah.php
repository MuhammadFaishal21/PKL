...
$sql = "SELECT MAX(CAST(SUBSTRING_INDEX(SUBSTRING_INDEX(no_usaha, '/', 2), '/', -1) AS UNSIGNED)) AS last_number 
        FROM usaha 
        WHERE no_usaha LIKE '$kodeSurat / % / KESRA-HB / $tahun'";
        ...
        <div class="card">
        	<div class="card-header border-bottom border-dashed">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0 flex-grow-1">Tambah Data Surat Keterangan Usaha</h4> 
                </div>
            </div><!-- end card header -->
            ...
            <div class="card-body">
                ...
                <form class="needs-validation" novalidate method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="no_usaha" value="<?= $noSurat ?>" readonly required>
                        </div>
                    </div>  
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" name="fc_pbb" required>
                        </div>
                    </div>  
                    <div class="row mb-2">
                ...
                <?php
                    if (isset($_POST['tambah'])) {
                        ...
                        $uploadDir = "../admin/assets/berkas/usaha/";
                        ...
                        $fotoUsaha = $_FILES['foto_usaha']['name'];
                        $fotoUsahaTmp = $_FILES['foto_usaha']['tmp_name'];
                        ...
                        if ($_FILES['pengantar_rt']['size'] > $maxFileSize || 
                            ...
                            $_FILES['fc_pbb']['size'] > $maxFileSize ||
                            $_FILES['foto_usaha']['size'] > $maxFileSize) {
                        ...
                        if (!in_array($_FILES['pengantar_rt']['type'], $allowedTypes) || 
                            ...
                            !in_array($_FILES['fc_pbb']['type'], $allowedTypes) ||
                            !in_array($_FILES['foto_usaha']['type'], $allowedTypes)) {
                        ...
                        if (move_uploaded_file($pengantarRtTmp, $pengantarRtPath) &&
                            ...
                            $query = "INSERT INTO usaha (id_jenis_surat, no_usaha, id_warga, tgl_pengajuan, jenis_usaha, nama_usaha, alamat_usaha, keperluan, pengantar_rt, fc_ktp, fc_kk, fc_pbb, foto_usaha, status_usaha) 
                                      VALUES ('$id_jenis_surat', '$no_usaha', '$id_warga', '$tgl_pengajuan', '$jenis_usaha', '$nama_usaha', '$alamat_usaha', '$keperluan', '$pengantarRt', '$fcKtp', '$fcKk', '$fcPBB', '$fotoUsaha', 'Pending')";
