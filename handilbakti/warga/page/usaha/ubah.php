            ...
            <div class="card-body">
                ...
                <?php
                    if (isset($_POST['ubah'])) {
                        ...
                        $query = "UPDATE usaha SET jenis_usaha = '$jenis_usaha', nama_usaha = '$nama_usaha', alamat_usaha = '$alamat_usaha', keperluan = '$keperluan', status_usaha = 'Pending' $updateFields WHERE id_usaha = $id_usaha";
