                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="tgl_warga" data-provider="flatpickr" data-date-format="d M, Y" value="<?= $data['tgl_warga']; ?>" required>
                                </div>
                            </div>
                            <div class="row mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <a href="?page=warga&aksi=lihat&id_warga=<?= $id_warga ?>" class="btn btn-danger btn-sm">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            echo "<script>
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            window.location.href = '?page=warga&aksi=lihat&id_warga=$id_warga';
                                        }
                                    });
                                  </script>";
                        } else {
